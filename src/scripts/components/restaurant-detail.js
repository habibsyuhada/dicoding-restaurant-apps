        ...
        <div id="detail" class="detail">
          <div class="detail-container">
            <div class="detail">
              ...
              <img class="lazyload detail-picture" crossorigin="anonymous" data-src="${CONFIG.BASE_IMAGE_URL + this.d_restaurant.pictureId}" alt="Gambar Restoran ${this.d_restaurant.name}">
